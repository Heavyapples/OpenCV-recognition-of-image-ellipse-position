...
int main() {
    // 导入图片
    Mat src = imread("C:/Users/13729/Documents/WeChat Files/wxid_a6l9v8idcwc822/FileStorage/File/2023-04/test/test/test7.jpg", IMREAD_COLOR);
    if (src.empty()) {
        cerr << "无法读取图片" << endl;
        return -1;
    }
...
RotatedRect detectLargestEllipse(Mat& src) {
    Mat hsv, redMask1, redMask2, redMask, gray, blurred, binary;
